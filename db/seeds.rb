...
# explorers
Ship.create!(sku: 'astrolobe-size-1', name: 'Astrolobe Size 1', description: 'The Astrolabe was a horse barge converted to an exploration ship of the French Navy and was originally named Coquille. She is famous for her travels with Jules Dumont d’Urville.', dimension: 'Model Dimensions: Length 60cm x Width 17cm x Height 44cm', category: explorer, photo_url: 'https://shop.bobatoshipmodels.com/wp-content/uploads/2019/11/Astrolobe.jpg')
